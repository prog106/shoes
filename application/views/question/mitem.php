    <tr>
        ...
        <td style="vertical-align:middle"><a href="javascript:;" class="modthis btn btn-xs btn-primary" id="modthis<?=$que_srl?>" data-que="<?=$que_srl?>" data-start="<?=$start?>" data-main_start="<?=$main_start?>" data-main_end="<?=$main_end?>"><span class="glyphicon glyphicon-edit" style="font-size:13px;"></span></a></td>
    </tr>
