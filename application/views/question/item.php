    <tr>
        ...
        <td><span style="font-size:11px"><?=$create_at?></span><h5 style="cursor:pointer;" class="link" id="question<?=$que_srl?>" data-link="/answer/view/<?=$que_srl?>"><?=nl2br(strip_tags($question))?></h5><span style="font-size:11px">응답 <?=$respond?> &nbsp; 좋아요 <?=$likes?></span></td>
